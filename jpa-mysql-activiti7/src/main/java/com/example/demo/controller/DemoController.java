...
private static final Logger logger = LoggerFactory.getLogger(DemoController.class);
	...
	/**
	 * 部署流程定义,spring会自动部署,这里写的是手动部署,可以不用管这个,
	 * @return
	 */
	@RequestMapping(value="/deploy")
	@ResponseBody
	private Deployment deploymentProc() {
	...
	@ResponseBody
	public String employeeApply(String taskId,String jobNumber,String leaveDays,String leaveReason){
		/*
		 * 获取请求参数
		"taskId":// 任务ID
		"jobNumber": // 工号
